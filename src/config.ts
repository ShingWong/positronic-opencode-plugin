...
export type BrainCfgType = z.infer<typeof BrainCfg>;
export type PositronicCfgType = z.infer<typeof PositronicCfg>;

function configPath(dir: string): string {
  return path.join(dir, ".positronic", "config.json");
}

export function loadConfig(dir: string): PositronicCfgType {
...
export function saveConfig(dir: string, cfg: unknown): void {
...
export function getBrains(dir: string): Record<string, BrainCfgType> {
